...
# ******************** MULTIPLE CLIENT FUNCTIONS
    def authenticateUserWithPushThenPolling(self, requestIdPush, requestIdPoll, userId, queryTimeout=60, queryInterval=5,
        ...
        print (push)
        if push.transactionId != None:
            transaction_id = push.transactionId
        ...
        for sec in range(1,queryTimeout // queryInterval):
            ...
            poll_status = self.queryClient.service.pollPushStatus(requestId=requestIdPoll,transactionId=transaction_id)
            res = poll_status
